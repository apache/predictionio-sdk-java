...
/**
 * EventClient contains the generic methods createEvent() and getEvent() for importing and accessing
 * events, as well as helper methods such as setUser(), unsetItem() and userActionItem() for
 * convenience. Methods with an "AsFuture" suffix are asynchronous.
 *
 * <p>Multiple simultaneous asynchronous requests is made possible by the high performance backend
 * provided by the <a href="https://github.com/AsyncHttpClient/async-http-client">Async Http
 * Client</a>.
 *
 * @version 0.8.3
 * @since 0.8.0
...
public class EventClient extends BaseClient {
  ...
  /**
   * Instantiate a PredictionIO RESTful API Event Client using default values for API URL and
  ...
  /**
   * Instantiate a PredictionIO RESTful API Event Client using default values in {@link
   * BaseClient}.
   *
   * @param accessKey the access key that this client will use to communicate with the API
  ...
  /**
   * Instantiate a PredictionIO RESTful API Event Client using default values in {@link BaseClient}
   ...
   */
  public EventClient(String accessKey, String eventUrl, int threadLimit, int queueSize) {
   ...
   *
   * @param response an instance of {@link FutureAPIResponse} returned from {@link
   * #createEventAsFuture}
   * @return event ID from the server
   * @throws ExecutionException indicates an error in the HTTP backend
   * @throws InterruptedException indicates an interruption during the HTTP operation
  ...
  /**
   * Sets properties of a item. Implicitly creates the item if it's not already there. Properties
   * could be empty.
   *
   * @param iid ID of the item
   * @param properties a map of all the properties to be associated with the item, could be empty
  ...
  /**
   * Sends a user-action-on-item request. Similar to {@link #userActionItemAsFuture(String, String,
   * String, Map, DateTime) #userActionItemAsFuture(String, String, String, Map&lt;String,
   * Object\gt;, DateTime)} except event time is not specified and recorded as the time when the
   * function is called.
   */
  public FutureAPIResponse userActionItemAsFuture(String action, String uid, String iid,
  ...
  /**
   * Records a user-action-on-item event. Similar to {@link #userActionItem(String, String, String,
   * Map, DateTime) userActionItem(String, String, String, Map&lt;String, Object&gt;, DateTime)}
